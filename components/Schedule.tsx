        ...
        <div className="p-12 md:p-24 flex flex-col justify-between bg-white/80 backdrop-blur-sm lg:bg-transparent">
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <h2 className="text-6xl md:text-8xl font-serif font-black tracking-tighter uppercase leading-[0.85] italic text-archive-charcoal">
                Events & <br /> <span className="not-italic">Program.</span>
              </h2>
            </div>
          ...
          <div className="pt-12 flex flex-col items-start gap-4">
            <span className="text-[8px] font-mono text-archive-clay font-black tracking-widest uppercase">SYST_LOG // AUTO_UPDATE_ACTIVE</span>
            <button className="text-[10px] font-black tracking-[0.4em] uppercase text-archive-charcoal border-b border-archive-clay/40 pb-2 hover:border-archive-clay transition-all flex items-center gap-3">
              Full Archive Search <ArrowUpRight size={12} />
            </button>
          </div>
        </div>
        ...
        <div className="p-12 md:p-24 flex flex-col justify-center space-y-12 bg-archive-charcoal/95 lg:bg-transparent overflow-hidden">
          <div className="space-y-2 shrink-0">
            <div className="flex justify-between items-end border-b border-white/20 pb-4">
              ...
              <span className="text-[9px] font-mono text-white/20 uppercase">REC_COUNT: {currentData.length}</span>
            </div>
          </div>
                ...
                {currentData.map((event, idx) => (
                  ...
                  >
                    <div className="shrink-0 space-y-2 text-left w-24">
                      <div className="text-5xl font-serif font-black text-archive-clay leading-none">{event.date}</div>
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="space-y-2">
                        ...
                        <h3 className="text-2xl md:text-3xl font-serif font-black uppercase italic leading-tight text-white group-hover:text-archive-clay transition-colors">
                          {event.title}
                        </h3>
                      </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        {activeTab === 'Upcoming' && (
                          <button className="flex items-center gap-4 group/btn whitespace-nowrap">
                             ...
                             <span className="text-[9px] font-black tracking-widest uppercase text-white/60 group-hover/btn:text-white">Request Entry</span>
                          </button>
                        )}
                      </div>
                    </div>
