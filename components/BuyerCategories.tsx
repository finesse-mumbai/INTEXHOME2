      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-32 gap-12">
          <div className="space-y-6">
            ...
            <h2 className="text-7xl md:text-9xl font-serif font-black tracking-tighter uppercase italic text-archive-charcoal leading-[0.8]">
              BUYER <br /><span className="not-italic text-outline">PROFILE.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-black text-archive-cream uppercase italic leading-[0.9]">
                JOIN THE <br /> <span className="not-italic text-archive-clay">TEXTILE NETWORK.</span>
              </h3>
        ...
        {/* Technical Footer */}
        <div className="mt-24 pt-12 border-t border-archive-charcoal/10 flex flex-wrap justify-between items-center gap-8">
           <div className="flex items-center gap-4">
              <span className="text-[8px] font-black tracking-[0.5em] text-archive-clay uppercase">Registry_Ref: IX-2025-MATRIX</span>
              <div className="w-4 h-[1px] bg-archive-clay/20"></div>
              <span className="text-[8px] font-black tracking-[0.5em] text-archive-charcoal uppercase">Items Indexed: {BUYER_PROFILES.length}</span>
           </div>
           <div className="flex items-center gap-2">
              <span className="text-[8px] font-black tracking-[0.2em] uppercase opacity-30">Scan Status:</span>
              <div className="flex gap-1">
                {[...Array(8)].map((_, i) => (
                  <div key={i} className="w-4 h-1 bg-archive-clay/40 animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}></div>
                ))}
              </div>
           </div>
        </div>
    ...
    >
      ...
      <div className="flex justify-between items-start relative z-10 shrink-0">
        <div className="space-y-1">
          <span className="text-[9px] font-black text-archive-clay tracking-[0.4em] uppercase block">Ref_{serial}</span>
      ...
      <div className="relative z-10 mt-auto">
        ...
        <h4 className="text-xl font-serif font-black uppercase italic leading-tight text-archive-charcoal group-hover:text-archive-clay transition-all line-clamp-2">
          {profile.title}
        </h4>
      </div>
