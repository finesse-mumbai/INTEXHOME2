    ...
    <section className="py-40 bg-archive-cream border-b border-archive-charcoal" id="blog">
      <div className="max-w-[1440px] mx-auto px-12">
        <div className="text-center mb-24 space-y-4">
          ...
          <h2 className="text-6xl font-serif font-black tracking-tighter uppercase italic text-archive-charcoal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-1px bg-archive-charcoal border border-archive-charcoal">
          ...
          <div className="md:col-span-4 bg-archive-cream flex flex-col group p-6">
             <div className="aspect-[4/5] border border-archive-charcoal overflow-hidden relative">
                <img src="https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale brightness-75 group-hover:scale-105 transition-transform duration-1000" />
             </div>
             <div className="pt-8 space-y-4">
                <span className="text-[9px] font-black tracking-widest uppercase text-archive-clay">Admin _ Press Release</span>
                <h3 className="text-2xl font-serif font-black uppercase italic leading-tight text-archive-charcoal group-hover:text-archive-clay transition-colors">Celebrating Authentic Marathon at Our Museum</h3>
          ...
          <div className="md:col-span-4 bg-archive-cream flex flex-col">
             <div className="flex-1 bg-archive-clay/5 p-12 flex flex-col justify-center items-center text-center relative group">
                <div className="text-7xl font-serif font-black text-archive-clay opacity-10 absolute top-4 left-4">“</div>
                <p className="text-2xl font-serif font-black uppercase italic leading-tight mb-8 text-archive-charcoal group-hover:text-archive-clay transition-colors">
             ...
             <div className="h-64 border-t border-archive-charcoal overflow-hidden grayscale brightness-50">
          ...
          <div className="md:col-span-4 bg-archive-cream flex flex-col group p-6 border-l border-archive-charcoal">
             <div className="aspect-[4/5] border border-archive-charcoal overflow-hidden relative">
                <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale brightness-75 group-hover:scale-105 transition-transform duration-1000" />
             </div>
             <div className="pt-8 space-y-4">
                <span className="text-[9px] font-black tracking-widest uppercase text-archive-clay">Admin _ Press Release</span>
                <h3 className="text-2xl font-serif font-black uppercase italic leading-tight text-archive-charcoal group-hover:text-archive-clay transition-colors">The Impact of Material Innovation in Modern Art</h3>
                <p className="text-[10px] font-medium leading-relaxed uppercase tracking-widest text-archive-charcoal opacity-70">Explain to you how all this mistaken idea of denouncing pleasure...</p>
                <div className="pt-4 flex justify-between items-center text-[9px] font-black tracking-widest border-t border-archive-charcoal/10">
                   <span className="text-archive-clay hover:underline cursor-pointer">READ MORE +</span>
                   <span className="text-archive-charcoal opacity-40">21.10.2025</span>
