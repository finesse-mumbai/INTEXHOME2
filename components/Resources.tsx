  ...
  return (
    <section className="py-40 bg-archive-charcoal text-archive-cream border-t border-archive-clay/20 relative overflow-hidden" id="resources">
      ...
      <div className="absolute top-0 right-0 h-full flex items-center pointer-events-none select-none">
        <span className="text-[25vw] font-black text-white opacity-[0.01] rotate-90 leading-none uppercase tracking-tighter">RESOURCE</span>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-24 gap-8">
          <div className="space-y-6">
            ...
            <h2 className="text-7xl md:text-8xl font-serif font-black tracking-tighter uppercase italic leading-[0.7] text-archive-cream">
              ASSET <br /><span className="not-italic text-outline" style={{ WebkitTextStroke: '1px rgba(243, 235, 232, 0.2)' }}>LIBRARY.</span>
            </h2>
          </div>
        ...
        {/* Data Stream Footer */}
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-between items-center gap-8 text-[8px] font-black tracking-[0.4em] uppercase text-archive-clay opacity-30">
           <div className="flex gap-8">
              <span>/// ARCHIVE_ENCRYPTED</span>
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="flex flex-col gap-1">
          <span className="text-[9px] font-black text-archive-clay tracking-[0.3em] uppercase">ID_{serial}</span>
          <div className="w-4 h-[1px] bg-archive-clay/60 group-hover:w-8 transition-all"></div>
        </div>
        <div className="text-[8px] font-black tracking-widest text-archive-cream/40 group-hover:text-archive-cream transition-colors uppercase">
          SECURE_FILE
        </div>
      </div>
      ...
      <div className="relative z-10 space-y-10">
        ...
        <div className="space-y-4">
          <h3 className="text-3xl font-serif font-black uppercase italic tracking-tighter leading-[0.8] text-archive-cream group-hover:text-archive-clay transition-colors duration-500">
            {resource.title}
          </h3>
