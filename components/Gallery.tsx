      ...
      <div className="max-w-[1440px] mx-auto px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          <div className="space-y-6">
            ...
            <h2 className="text-6xl md:text-9xl font-black tracking-tighter uppercase leading-none italic text-archive-charcoal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
           <div className="lg:col-span-8 overflow-hidden border border-archive-charcoal aspect-video relative group">
              <motion.img 
                ...
                className="w-full h-full object-cover grayscale/70 brightness-90"
              />
           ...
           <div className="lg:col-span-4 space-y-12">
              <div className="space-y-4">
                 ...
                 <h3 className="text-5xl font-serif font-black uppercase leading-tight italic text-archive-charcoal">{GALLERY_ITEMS[activeIndex].title}</h3>
                 <p className="text-sm font-bold text-archive-bronze opacity-80 uppercase leading-relaxed tracking-widest">
                   Verified archive entry representing technical excellence in South Asian textile manufacturing.
                 </p>
              </div>
