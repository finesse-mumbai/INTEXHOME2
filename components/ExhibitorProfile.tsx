          ...
          {EXHIBITIONS.map((ex, idx) => (
            ...
            >
              <div className="lg:col-span-1 border-r border-archive-charcoal/10 p-6 flex flex-col justify-between items-center text-center bg-archive-cream/30">
                <span className="text-[8px] font-mono text-archive-clay font-black">NODE_{idx + 1}</span>
                <span className="text-4xl font-serif font-black italic text-archive-charcoal/10 group-hover:text-archive-clay transition-colors duration-700">0{idx + 1}</span>
              ...
              <div className="lg:col-span-5 border-r border-archive-charcoal/10 p-10 flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[9px] font-mono font-bold text-archive-charcoal/40 uppercase tracking-[0.3em]">{ex.code}</span>
                  </div>
                  <h3 className="text-4xl md:text-5xl font-serif font-black uppercase italic text-archive-charcoal leading-[0.9] group-hover:translate-x-2 transition-transform duration-1000">
                    {ex.title}
                  </h3>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <span className="text-[8px] font-mono text-archive-charcoal/30 uppercase block tracking-tighter">Temporal_Sync</span>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <span className="text-[8px] font-mono text-archive-charcoal/30 uppercase block tracking-tighter">Geoloc_Point</span>
              ...
              <div className="lg:col-span-3 relative group/img overflow-hidden min-h-[250px] lg:min-h-0">
                <img 
                  src={ex.imageUrl} 
                  className="absolute inset-0 w-full h-full object-cover grayscale brightness-90 contrast-125 group-hover:scale-110 group-hover:brightness-50 transition-all duration-[2000ms]" 
                  alt={ex.title}
                />
