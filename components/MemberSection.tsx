      ...
      <div className="max-w-[1440px] mx-auto px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
             ...
             <h2 className="text-6xl font-serif font-black tracking-tighter leading-none italic uppercase text-archive-charcoal">
               Become a <br /> <span className="not-italic">Member of Intex</span>
             </h2>
          </div>
